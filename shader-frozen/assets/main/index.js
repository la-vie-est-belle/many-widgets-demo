...
System.register("chunks:///_virtual/shader-test.ts",["./_rollupPluginModLoBabelHelpers.js","cc"],(function(e){"use strict";var t,r,i,n,o,l,s,a,p,u,c;return{setters:[function(e){t=e.applyDecoratedDescriptor,r=e.inheritsLoose,i=e.initializerDefineProperty,n=e.assertThisInitialized},function(e){o=e.cclegacy,l=e._decorator,s=e.Node,a=e.Slider,p=e.Label,u=e.Sprite,c=e.Component}],execute:function(){var d,h,f,y,b,g,v,m,z;o._RF.push({},"1bb17bFyipE856EyORI3p5H","shader-test",void 0);var S=l.ccclass,N=l.property;e("ShaderTest",(d=S("ShaderTest"),h=N({type:s}),f=N({type:a}),y=N({type:p}),d((v=t((g=function(e){function t(){for(var t,r=arguments.length,o=new Array(r),l=0;l<r;l++)o[l]=arguments[l];return t=e.call.apply(e,[this].concat(o))||this,i(n(t),"spriteNode",v,n(t)),i(n(t),"slider",m,n(t)),i(n(t),"label",z,n(t)),t}r(t,e);var o=t.prototype;return o.start=function(){var e=this.spriteNode.getComponent(u).material;null==e||e.setProperty("frozenThreshold",0)},o.changeAgingValue=function(){var e=this.spriteNode.getComponent(u),t=null==e?void 0:e.material;null==t||t.setProperty("frozenThreshold",this.slider.progress),this.label.string=this.slider.progress.toFixed(2).toString()},t}(c)).prototype,"spriteNode",[h],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),m=t(g.prototype,"slider",[f],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),z=t(g.prototype,"label",[y],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),b=g))||b));o._RF.pop()}}}));
